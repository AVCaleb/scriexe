...
S = {
    ...
    "find_hint": {"en": "n next · N prev · Ctrl-U/D ×5 · g/G first/last · Enter accept · Esc exit",
                  "zh": "n 下一个 · N 上一个 · Ctrl-U/D ×5 · g/G 首末 · Enter 确认 · Esc 退出"},
    "word_hint": {"en": "j/k select · Ctrl-U/D ×5 · g/G first/last · Enter jump · Esc back",
                  "zh": "j/k 选择 · Ctrl-U/D ×5 · g/G 首末 · Enter 跳转 · Esc 返回"},
    "result_hint": {"en": "j/k select · Ctrl-U/D ×5 · g/G first/last · Enter jump · Esc back",
                    "zh": "j/k 选择 · Ctrl-U/D ×5 · g/G 首末 · Enter 跳转 · Esc 返回"},
