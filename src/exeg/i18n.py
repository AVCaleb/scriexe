...
S = {
    # status / mode hints
    "nav_hint": {"en": "j/k move · Ctrl-D down 5 · Ctrl-U up 5 · l/h column · Enter read · y copy · ? help",
                 "zh": "j/k 移动 · Ctrl-D 下5 · Ctrl-U 上5 · l/h 切换列 · Enter 阅读 · y 复制 · ? 帮助"},
    "normal_hint": {"en": "j/k verse · [/] chapter · g/G first/last · V select · y copy · z scope · +/- window · i note · / find · b back · p set bookmark · o settings · ? help · :q quit",
                    "zh": "j/k 移动 · [/] 章节 · g/G 首末节 · V 选择 · y 复制 · z 范围 · +/- 窗口 · o 设置 · ? 帮助 · :q 退出"},
    "find_hint": {"en": "n next · N prev · Ctrl-D down 5 · Ctrl-U up 5 · g/G first/last · Enter accept · Esc exit",
                  "zh": "n 下一个 · N 上一个 · Ctrl-D 下5 · Ctrl-U 上5 · g/G 首末 · Enter 确认 · Esc 退出"},
    "word_hint": {"en": "j/k select · Ctrl-D down 5 · Ctrl-U up 5 · g/G first/last · Enter jump · Esc back",
                  "zh": "j/k 选择 · Ctrl-D 下5 · Ctrl-U 上5 · g/G 首末 · Enter 跳转 · Esc 返回"},
    "result_hint": {"en": "j/k select · Ctrl-D down 5 · Ctrl-U up 5 · g/G first/last · Enter jump · Esc back",
                    "zh": "j/k 选择 · Ctrl-D 下5 · Ctrl-U 上5 · g/G 首末 · Enter 跳转 · Esc 返回"},
    "insert_status": {"en": " INSERT · type to edit · Esc save · Ctrl-C discard · Ctrl-V paste · Backspace del ",
                      "zh": " 插入 · 输入编辑 · Esc 保存 · Ctrl-C 放弃 · Ctrl-V 粘贴 · Backspace 删除 "},
    "vim_insert_status": {"en": "INSERT · Esc Normal · Ctrl-C discard",
                          "zh": "INSERT · Esc 普通模式 · Ctrl-C 放弃"},
    "vim_normal_status": {"en": "NORMAL · i/a insert · v/V select · yy copy · p/P paste · :wq/ZZ save · :q/:q!/!q exit",
                          "zh": "NORMAL · i/a 插入 · v/V 选择 · yy 复制 · p/P 粘贴 · :wq/ZZ 保存 · :q/:q!/!q 退出"},
    ...
    "esc_save_hint": {"en": "Esc save · Ctrl-C discard · Ctrl-V paste", "zh": "Esc 保存 · Ctrl-C 放弃 · Ctrl-V 粘贴"},
